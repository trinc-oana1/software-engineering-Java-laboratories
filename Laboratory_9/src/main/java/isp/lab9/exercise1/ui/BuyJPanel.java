...
public class BuyJPanel extends JPanel {
    ...
    private void initComponents(){
        ...
        buyButton.addActionListener(e ->
                buyStocks(symbolComboBox, costTextField, quantityTextField, availableFundsTextField));
                            ...
                            JTextField availableFundsTextField)
    {
        ...
        BigDecimal value = new BigDecimal(costTextField.getText());
        BigDecimal r = this.mainFrame.getPortfolio().buy(symbol, quantity, value);
        availableFundsTextField.setText("The funds are available");
    }
